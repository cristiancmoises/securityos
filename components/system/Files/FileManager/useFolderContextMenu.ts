                  ...
                  menu: WALLPAPER_MENU.reduce<MenuItem[]>(
                    ...
                    MENU_SEPERATOR,
                    {
                      action: () => {
                        ...
                        // Accept a same-origin proxied link (e.g. copied from the
                        // Tor Browser) as well as a normal http/https image URL.
                        let valid = value.startsWith("/api/proxy");
                    ...
                    },
                    {
                      ...
                      menu: (
                        ...
                        action: () => setSessionWallpaper(wallpaperImage, fit),
                        label: fit,
                        toggle: wallpaperFit === fit,
                      })),
                    },
                  ]),
                },
