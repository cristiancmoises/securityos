...
// For TRUSTED same-origin embedded apps and for navigating the
...
// SecurityOS brand wallpaper (Cyber-Neon Glass): the emblem with a cyan glow over
// a deep blue-black gradient, HUD ring and wordmark. A static image (no animated
// WebGL) keeps first paint fast; users can still pick MATRIX 3D / VANTA / another
// picture from the wallpaper menu. Generated by scripts/genBrandWallpaper.mjs.
export const DEFAULT_WALLPAPER =
  "/Users/Public/Pictures/Wallpapers/Security/securityos-logo.webp";

export const DEFAULT_WALLPAPER_FIT: WallpaperFit = "fill";

// Light, original abstract wallpaper paired with the neutral Undercover theme so
// the workspace remains coherent (dark text on a light desktop). Generated by
// scripts/genUndercoverWallpaper.mjs. Toggled from the taskbar right-click menu.
export const UNDERCOVER_WALLPAPER =
  "/Users/Public/Pictures/Wallpapers/Undercover/enterprise.webp";
