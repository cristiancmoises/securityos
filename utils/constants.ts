...
export const DEFAULT_WALLPAPER =
  "/Users/Public/Pictures/Wallpapers/Security/securityos-brand.webp";

export const DEFAULT_WALLPAPER_FIT: WallpaperFit = "fill";

// Light "bloom" wallpaper paired with the Undercover (Windows 11) theme so the
// disguise is coherent (dark text on a light desktop). Generated by
// scripts/genUndercoverWallpaper.mjs. Toggled from the taskbar right-click menu.
export const UNDERCOVER_WALLPAPER =
  "/Users/Public/Pictures/Wallpapers/Undercover/win11.webp";
