...
This function should only modify configuration layer settings."
  (setq-default
   ...
   '(
     ;; SecurityOS Cloudmacs — productivity layers.
     auto-completion
     better-defaults
     emacs-lisp
     helm
...
before packages are loaded."
  ...
  ;; --- SecurityOS Cloudmacs user config -------------------------------------

  ;; EWW (built-in browser): quick leader + global keys.
  (with-eval-after-load 'eww
    (setq eww-search-prefix "https://duckduckgo.com/html/?q="))
  (spacemacs/set-leader-keys "aw" #'eww)
  (global-set-key (kbd "C-c w") #'eww)

  ;; Org-mode basics: a notes/agenda home under the mounted data dir.
  (with-eval-after-load 'org
    (setq org-directory "~/data/org"
          org-agenda-files (list "~/data/org")
