...
which terms apply depends on _which part_ you're using.
...
| **Vaptvupt** — the encryption tool & its **`.zupt`** format / engine | **GNU AGPL-3.0-or-later _or_ Commercial** (your option) | [`LICENSE-VAPTVUPT.md`](LICENSE-VAPTVUPT.md) |
...
- **GNU AGPL-3.0-or-later** — free software. You may run, study, share, and modify
  ...
  (§13)** also means that if you run a _modified_ Vaptvupt as a **network service**,
